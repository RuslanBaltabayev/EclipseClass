...
public class Citizens {
	...
	public static void main(String[] args) {
		...
		/*
		 * Declare int variables: seniorCitizens, nonSeniorCitizens, age -Create a
		 * Scanner object - Ask user to enter count for seniorCitizens and
		 * nonSeniorCitizens using message:
		 * "Enter current count for seniorCitizens and nonSeniorCitizens:"
		 * 
		 * -Ask user to enter age: "What is new citizen's age?"
		 * 
		 ...
		 * 
		 * -At last, print another message: "New seniorCitizens count ValueOfVariable"
		 * "New nonSeniorCitizens count ValueOfVariable"
		 * 
		 * Example Run:
		 * 
		 * Enter current count for seniorCitizens and nonSeniorCitizens: 5 4 What is new
		 * citizen's age? 66 Senior Citizen New seniorCitizens count 6 New
		 * nonSeniorCitizens count 4
		 */
